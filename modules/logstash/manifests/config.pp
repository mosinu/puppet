class logstash::config {
        ...
        file { "cisco-firewalls":
                ensure => present,
                path => "/opt/logstash/patterns/cisco-firewalls",
                source => "puppet:///modules/${module_name}/cisco-firewalls",
                group => "root",
                owner => "root",
                mode  => "0644",
        }
        ...
        file { "cisco-std":
                ...
                path => "/opt/logstash/patterns/cisco-std",
                source => "puppet:///modules/${module_name}/cisco-std",
                group => "root",
                owner => "root",
                mode  => "0644",
        }
